...
- Fill the data for `emails.txt` file. Your emails's addresses.
...
### 2.1 `passwords.txt` - 🗂️ User Data

- Fill the data for `emails.txt` file. Your emails's passwords.
